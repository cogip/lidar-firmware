 ...
 */
void lidar_usart_setup(usart_t *usart, uint32_t baudrate);

/**
 * \fn
 * \brief setup usart. tunable baudrate, 8-data bits, no parity, 1 stop bit enable interruption on RX
 */
void stm32_usart_setup(usart_t *usart, uint32_t baudrate);
